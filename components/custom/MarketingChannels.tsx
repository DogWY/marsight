...
const MarketingChannels: React.FC<MarketingChannelsProps> = ({
  ...
  const MarketingChannelsBarChartData = [
    { name: 'Direct', value: (Direct / total * 100).toFixed(4) },
    { name: 'Email', value: (Email / total * 100).toFixed(4) },
    { name: 'Referrals', value: (Referrals / total * 100).toFixed(4) },
    { name: 'Social', value: (Social / total * 100).toFixed(4) },
    { name: 'OrganicSearch', value: (OrganicSearch / total * 100).toFixed(4) },
    { name: 'PaidSearch', value: (PaidSearch / total * 100).toFixed(4) },
    { name: 'DisplayAds', value: (DisplayAds / total * 100).toFixed(4) },
  ]
