...
export default function Component() {
  ...
  const array2ToDisplay =
    frontMentions?.Mentions_from_the_most_popular_public_profiles.slice(0, 10) || [];
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#ffffff] p-4">
      <Resizable
        ...
        handleComponent={{
          right: (
            <div className="w-1 h-full bg-gray-300 cursor-col-resize hover:bg-gray-400 transition-colors" />
          ),
        }}
      >
        <div className="h-full overflow-auto">
          ...
          <div className="p-4 space-y-4 min-w-[500px]">
            ...
            {frontSearchAnalysis &&
            frontTraffic &&
            frontSearchAnalysis.organic_brand.Records.length > 0 &&
            frontSearchAnalysis.organic_nonbrand.Records.length > 0 &&
            frontSearchAnalysis.paid_brand.Records.length > 0 &&
            frontSearchAnalysis.paid_nonbrand.Records.length > 0 &&
            frontSearchAnalysis.all_brand.KeywordsCount &&
            frontSearchAnalysis.all_brand.OverallClicks &&
            frontSearchAnalysis.organic_nonbrand.KeywordsCount &&
            frontSearchAnalysis.organic_brand.KeywordsCount &&
            frontSearchAnalysis.paid_brand.KeywordsCount &&
            frontSearchAnalysis.paid_nonbrand.KeywordsCount &&
            frontTraffic.total.AvgMonthVisits ? (
              <SearchAnalysis
                dataofbox={{
            ...
            frontMentionChart &&
            frontMentionChart.total_results ? (
              <SocialMediaAnalysis
                TotalSocialVisits={frontSocialOverview.Records.reduce(
                  (total, record) => total + record.Visits,
                  0
                )}
            ...
            {frontMentions &&
            frontMentions.Mentions_from_the_most_popular_public_profiles.length > 0 &&
            frontMentions.The_most_popular_mentions.length > 0 ? (
              <Mentions
